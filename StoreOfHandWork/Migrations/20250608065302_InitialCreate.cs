        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GeneralConditions = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ExcludedCategories = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    RefundPolicy = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    ExchangePolicy = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ReturnRequests_Products_ExchangeProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReturnRequests_ExchangeProductId",
